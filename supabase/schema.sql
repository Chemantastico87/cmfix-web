...
CREATE TABLE IF NOT EXISTS company_settings (
  ...
  trade_name TEXT NOT NULL DEFAULT 'CM FIX — Servicios Tecnológicos',
  cif TEXT DEFAULT 'B-12345678',
  phone TEXT DEFAULT '+34 600 000 000',
  whatsapp TEXT DEFAULT '+34 600 000 000',
  email TEXT DEFAULT 'contacto@cmfix.es',
  website TEXT DEFAULT 'https://cmfix.es',
  address TEXT DEFAULT 'Calle Tecnología 42',
  city TEXT DEFAULT 'Madrid',
  postal_code TEXT DEFAULT '28001',
